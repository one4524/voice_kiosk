...
m1 = "한식 메뉴의 종류는 '김치볶음밥', '김치치즈볶음밥', '소금덮밥', '제육덮밥', '뼈다귀해장국', '소고기미역국', '냉면', '간장불고기'  있습니다. 원하시는 메뉴를 말해주세요."
m2 = "백반 메뉴의 종류는 '제육정식', '간장불고기정식', '고등어정식' 있습니다. 원하시는 메뉴를 말해주세요."
m3 = "분식 메뉴의 종류는 '떡볶이', '라볶이', '라면', '기본김밥', '야채김밥', '참치김밥', '순대'  있습니다. 원하시는 메뉴를 말해주세요."
m4 = "양식 메뉴의 종류는 '크림파스타', '토마토파스타', '알리오올리오', '연어샐러드', '감바스'  있습니다. 원하시는 메뉴를 말해주세요."
m5 = "일식 메뉴의 종류는 '오므라이스', '왕돈까스', '치킨까스', '치즈돈까스', '냉모밀', '우동', '김치나베', '돈까스나베' 있습니다. 원하시는 메뉴를 말해주세요."
